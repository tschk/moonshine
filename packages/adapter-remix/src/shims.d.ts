declare module "@remix-run/react" {
  ...
  export function useFetcher<T = unknown>(): {
    ...
    data: T | undefined;
    Form: ComponentType<{ method?: string; action?: string; children?: ReactNode }>;
    submit: (data: unknown, opts?: { method?: string; action?: string }) => void;
    load: (href: string) => void;
  };
  export function useRevalidator(): { state: string; revalidate: () => void };
  export function useNavigation(): { state: string; location?: { pathname: string } };
